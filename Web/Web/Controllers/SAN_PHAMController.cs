...
namespace Web.Controllers
{
    public class SAN_PHAMController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaSP,TenSP,Gia,TrangThai,SoLuong,img")] SAN_PHAM sAN_PHAM)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaSP,TenSP,Gia,TrangThai,SoLuong,img")] SAN_PHAM sAN_PHAM)
        {
            if (ModelState.IsValid)
            {
