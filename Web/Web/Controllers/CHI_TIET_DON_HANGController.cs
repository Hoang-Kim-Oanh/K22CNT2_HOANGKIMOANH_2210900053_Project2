...
namespace Web.Controllers
{
    public class CHI_TIET_DON_HANGController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MACTDH,MaDH,MaSP,So_luong,Tong_tien")] CHI_TIET_DON_HANG cHI_TIET_DON_HANG)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MACTDH,MaDH,MaSP,So_luong,Tong_tien")] CHI_TIET_DON_HANG cHI_TIET_DON_HANG)
        {
            if (ModelState.IsValid)
            {
